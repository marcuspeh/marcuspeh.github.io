...
const mediclear: ProjectDataModel = {
  ...
  title: "MediClear",
  description: "Design to simplify health checkup report, MediClear is an easy to use platform that provides clear and contextualized test results. Apart from simplified test result, it also provides lifestyle management tips for the user.",
  tech: [
    {
      link: "https://nextjs.org/",
      text: "NextJs",
...
const ProjectData: ProjectDataModel[] = [
  aroundTheWorldIn80,
  markeet,
  splitlux,
  todoManager,
