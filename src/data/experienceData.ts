...
const govTechIntern: jsonObject = {
...
const reluvateIntern: jsonObject = {
    "title": ["Software Engineering Intern"],
...
const robotoFreelance: jsonObject = {
...
export const ExperienceData: jsonObject[] = [
    govTechIntern,
    reluvateIntern,
    nusTa,
    robotoFreelance,
